...
import c1 from "@/views/searchByStation/child/c1";
import c2 from "@/views/searchByStation/child/c2";
import c3 from "@/views/searchByStation/child/c3";
import showC1 from "@/views/searchByStation/show/showC1";
import showC2 from "@/views/searchByStation/show/showC2";
import showC3 from "@/views/searchByStation/show/showC3";
export default {
  name: "Station",
  components: {
